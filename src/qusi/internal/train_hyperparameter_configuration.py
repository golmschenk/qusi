...
class TrainHyperparameterConfiguration:
    ...
    :ivar global_batch_size: The size of the batch for each train process. Each training step will use a number of observations
    ...
    def new(
        ...
        :param global_batch_size: The size of the batch for each train process. Each training step will use a number of observations
            equal to this value multiplied by the number of train processes.
