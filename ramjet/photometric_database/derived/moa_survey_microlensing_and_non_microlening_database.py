...
class MoaSurveyMicrolensingAndNonMicrolensingWithTimeDatabase(StandardAndInjectedLightCurveDatabase):
    """
    A class for a database of MOA light curves including non-microlensing, and microlensing collections.
    """
    moa_data_interface = MoaDataInterface()
...
class MoaSurveyMicrolensingAndNonMicrolensingWithTimeAndHardCasesDatabase(StandardAndInjectedLightCurveDatabase):
    """
    A class for a database of MOA light curves including non-microlensing, and microlensing collections.
    """
    moa_data_interface = MoaDataInterface()
