...
class TestSelfLensingBinarySyntheticSignalsLightCurveCollection:
    ...
    def test_can_request_download_of_synthetic_csv_data_from_http(self, mock_path):
        with (patch.object(module.urllib.request, 'urlretrieve') as mock_urlretrieve,
            ...
            expected_save_path = light_curve_collection.data_directory.joinpath('synthetic_signals_csv_files.tar')
            ...
            assert mock_extractall.call_args[0][0] == light_curve_collection.data_directory
...
class TestReversedSelfLensingBinarySyntheticSignalsLightCurveCollection:
    def test_reversal_of_signals(self):
        ...
        light_curve_collection = module.ReversedSelfLensingBinarySyntheticSignalsLightCurveCollection()
        reversed_times, reversed_magnitudes = light_curve_collection.reverse_signal(times, magnitudes)
