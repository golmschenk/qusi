...
class TestTessTransitMetadata:
    ...
    def test_table_building_creates_rows_based_on_toi_dispositions(self, mock_tess_target_transit_disposition,
        ...
        with (patch.object(module.TessToiDataInterface, 'toi_dispositions',
                           new_callable=PropertyMock) as mock_toi_dispositions,
              patch.object(module.TessToiDataInterface, 'ctoi_dispositions',
                           new_callable=PropertyMock) as mock_ctoi_dispositions):
