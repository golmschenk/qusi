...
from ramjet.photometric_database.derived.moa_survey_microlensing_and_non_microlening_database import \
    MoaSurveyMicrolensingAndNonMicrolensingDatabase, MoaSurveyMicrolensingAndNonMicrolensingWithHardCasesDatabase, \
...
for log_name in log_names:
    ...
    # Adding time stamps
    test_split_number = int(log_name.split('_')[4])

    # Hard Cases, Easy cases, microlensing
    # test_split_number = int(log_name.split('_')[5])
    ...
    database = MoaSurveyMicrolensingAndNonMicrolensingWithTimeDatabase(test_split=test_split_number)
